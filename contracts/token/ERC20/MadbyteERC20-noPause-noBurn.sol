...
contract ERC20Mintable is ERC20Token, MinterRole {
...
contract ERC20Madbyte is ERC20Token, ERC20Mintable {
    ...
    constructor (
        ...
        ERC20Token(initialAccount, _tokenSymbol, _tokenName, initialBalance) {
